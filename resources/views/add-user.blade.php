            ...
            <div class="card-body">
                <form action="{{ route('add-user') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="full_name" class="form-control" value="{{ old('full_name') }}" id="formGroupExampleInput" placeholder="Enter Full Name">
                        @error('full_name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="phone_number" class="form-control" value="{{ old('phone_number') }}" id="formGroupExampleInput2" placeholder="Enter Phone Number">
                        @error('phone_number')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
